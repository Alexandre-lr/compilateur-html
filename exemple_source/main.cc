...
//    page_ptr->ajouter_bloc(paragraphe1);
...
//    page_ptr->ajouter_bloc(paragraphe2);
...
//    page_ptr->ajouter_commentaire(commentaire1);
...
//    page_ptr->ajouter_commentaire(commentaire2);
...
//    page_ptr->ajouter_bloc(commentaire3);
...
//    page_ptr->ajouter_bloc(paragraphe3);
//    c1["bloc"] = page_ptr->bloc(std::dynamic_pointer_cast<Constante>(c1.get("indice"))->valeur(), NoeudElement::Bloc_t::paragraphe);
...
//    c1["bloc"] = page_ptr->bloc(std::dynamic_pointer_cast<Constante>(c1.get("indice"))->valeur()-1, NoeudElement::Bloc_t::paragraphe);
//    std::dynamic_pointer_cast<BaliseStyle>(c1.get("bloc"))->style() = style4;
    ...
    std::dynamic_pointer_cast<BaliseTitre>(page_ptr->bloc(std::make_shared<Constante>(0), NoeudElement::Bloc_t::titre1))->attribut(Attribut::Attribut_t::couleurFond) = couleur1;
